...
/**
 * print_python_float - print some basic infor about Python float obj
...
void print_python_float(PyObject *p)
{
	...
	tmp = PyOS_double_to_string(d, 'r', 0, Py_DTSF_ADD_DOT_0, NULL);
	printf("  value: %s\n", tmp);
	fflush(stdout);
}

/**
 * print_python_bytes - print some basic info about Python byte obj
 * @p: pointer to PyObject p
 */
