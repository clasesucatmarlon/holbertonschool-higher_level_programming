...
class TestSquare(unittest.TestCase):
    ...
    def test_instance(self):
        ...
        self.assertEqual(var1._Base__nb_objects, 3)
        self.assertEqual(var2.id, 'hello')
        self.assertEqual(var2._Base__nb_objects, 3)
    ...
    def test_str(self):
        ...
        self.assertEqual(var4.__str__(), '[Square] (hello) 1/0 - 3')
    ...
    def test_update(self):
        ...
        self.assertEqual(var2.__str__(), '[Square] (hello) 2/0 - 3')
        with self.assertRaises(ValueError):
            var3.update("hello", -5)
            var4.update(x=9.5)
